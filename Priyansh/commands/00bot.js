  ...
  if ((event.body.toLowerCase() == "by") || (event.body.toLowerCase() == "byy")) {return api.sendMessage("by bye tata najar mat ana ab",threadID);
    ...
    if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib aao")) {
     ...
     if ((event.body.toLowerCase() == "bot") || (event.body.toLowerCase() == "bot")) {
       return api.sendMessage("𝐊𝐡𝐨𝐨𝐧 𝐤𝐚𝐫 𝐝𝐮𝐧𝐠𝗮 𝐭𝐞𝐫𝐚", threadID);
     };
...
if ((event.body.toLowerCase() == "🥱") || (event.body.toLowerCase() == "😑")) {
  ...
  if ((event.body.toLowerCase() == "Sudhar jao") || (event.body.toLowerCase() == "sudhar ja")) {
     return api.sendMessage("𝐌𝐞 𝐬𝐮𝐝𝐡𝐚𝐫 𝐝𝐮𝐧𝐠𝐢😒😒", threadID);
        ...
        if ((event.body.toLowerCase() == "💋") || (event.body.toLowerCase() == "💋💋💋")) {
       return api.sendMessage("Yah PaPpi ChaPpi Nhi kRr Kuch Kuch Nhi Bhot KucH HoTa Hai mko 🙈", threadID);
     };
       ...
       return api.sendMessage("𝐇𝐀𝐍 𝐁𝐇𝐀𝐈 𝐀𝐀𝐀 𝐆𝐘𝐀 𝐒𝐖𝐀𝐃 𝐓𝐎𝐓 𝐆𝐀𝐘𝐀 𝐃𝐈𝐋😂 ", threadID);
        ...
        if ((event.body.toLowerCase() == "🙄") || (event.body.toLowerCase() == "🙄🙄")) {
       return api.sendMessage("𝐔𝐩𝐚𝐫 𝐏𝐚𝐧𝐤𝐡𝐚 𝐜𝐡𝐚𝐥𝐭𝐚 𝐡𝐚𝐢 𝙩𝙪 𝙡𝙖𝙩𝙖𝙠 𝙠𝙮𝙪 𝙣𝙝𝙞 𝙟𝙖𝙩𝙖 𝙪𝙨𝙥𝙚🤣", threadID);
     };

           if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😣")) {
       return api.sendMessage("𝐓𝐘𝐀 𝐇𝐔𝐀𝐀 𝐁𝐀𝐂𝐇𝐀𝐀 😒", threadID);
     };

        if ((event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😂")) {
       return api.sendMessage(" 𝐉𝐚𝐲𝐝𝐚 𝐦𝐚𝐭 𝐡𝐚𝐬 𝐝𝐚𝐭 𝐭𝐨𝐝 𝐝𝐮𝐧𝐠𝒂😏", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "👍") || (event.body.toLowerCase() == "👎")) {
    return api.sendMessage(" 𝐈𝐬𝐤𝐨 𝐤𝐚𝐭𝐤𝐞 𝙩𝙚𝙧𝙖 𝙥𝙧𝙤𝙥𝙚𝙧𝙩𝙮 𝙖𝙥𝙣𝙚 𝙣𝙖𝙢 𝙠𝙧𝙖 𝙡𝙪🤨👈", threadID);
   };

    if ((event.body.toLowerCase() == "😴") || (event.body.toLowerCase() == "😴😴") || (event.body.toLowerCase() == "😴😴😴") || (event.body.toLowerCase() == "😴😴😴😴")) {
     return api.sendMessage("Tere Nak Me UngLi ghushed DunGa🤨👈", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "shat up") || (event.body.toLowerCase() == "shut up") || (event.body.toLowerCase() == "sat up") || (event.body.toLowerCase() == "muh bnd")) {
     return api.sendMessage("You Stup Up idiot😕👈", threadID);
   };

  if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "🥰🥰") || (event.body.toLowerCase() == "🥰🥰🥰") || (event.body.toLowerCase() == "🥰🥰🥰🥰")) {
     return api.sendMessage("Itna Khush lag Rhe Ho Setting Ho Gyi Kiya😂", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "kya hua") || (event.body.toLowerCase() == "kiya hua") || (event.body.toLowerCase() == "tya hua") || (event.body.toLowerCase() == "kiya huva")) {
     return api.sendMessage("कुछ नही बाबू रुचिता कि याद आ गई🥹👈", threadID);
   };
    ...
    if ((event.body.toLowerCase() == "chutiya bot") || (event.body.toLowerCase() == "Bot chutiya") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chutiya")) {
     return api.sendMessage("Hmm... Tum Chutiya ho bot to uhi badnam kar rakha h tum logo ne😾", threadID);
   };
if ((event.body.toLowerCase() == "satting karva de") || (event.body.toLowerCase() == "setting kara")) {
   ...
   if ((event.body.toLowerCase() == "🤫") || (event.body.toLowerCase() == "🤫🤫")) {
     return api.sendMessage(" 𝐍𝐡𝐢 𝐫𝐚𝐡𝐮𝐧𝐠𝙖 𝐜𝐡𝐮𝐩 𝐤𝐲𝐚 𝐤𝐫 𝐥𝐨𝐠𝐞 𝐭𝐮𝐦", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😁😁")) {
     return api.sendMessage(" 𝐁𝐑𝐔𝐒𝐇 𝐊𝐀𝐑𝐊𝐄 𝐀𝐀𝐎 𝐁𝐀𝐁𝐔 𝐁𝐀𝐃𝐁𝐔 𝐀𝐀 𝐑𝐀𝐇𝐀 𝐇𝐀𝐈🤭🤭🤭", threadID);
   };

   if ((event.body.toLowerCase() == "😔") || (event.body.toLowerCase() == "😔😔")) {
     return api.sendMessage("𝐒𝐀𝐃 𝐊𝐘𝐔 𝐇𝐀𝐈 𝐉𝐀𝐍𝐄𝐌𝐀𝐍 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 𝐁𝐇𝐀𝐆 𝐆𝐀𝐘𝐈 𝐊𝐘𝐀 𝐓𝐄𝐑𝐈 𝐋𝐀𝐓 𝐌𝐀𝐑𝐊𝐀 𝐓𝐄𝐊𝐎🤣❤️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "good afternoon") || (event.body.toLowerCase() == "good afternoon everyone") || (event.body.toLowerCase() == "⛲⛲⛲⛲⛲⛲⛲⛲⛲⛲") || (event.body.toLowerCase() == "good after noon")) {
     return api.sendMessage( "Dopehar ho gya aja khana khilata hu apne hato se bna ke bhuk lgi hogi mere janu ko😥",threadID);
   ...
   if ((event.body.toLowerCase() == "kamchor") || (event.body.toLowerCase() == "rakh de mobile")) {
     return api.sendMessage("Tum ho kamchor ChAlo baRTan MaNj Do aake ghr p mere🙈😋", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "good night") || (event.body.toLowerCase() == "tata")) {
     return api.sendMessage("by babu najar mt ana ab subhe tk😘", threadID);
   };

   if ((event.body.toLowerCase() == "malik hu") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik")) {
     return api.sendMessage("sorry malik maaf kr do ab nhi kruga  agli bar🥺🙏", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bhosdike") || (event.body.toLowerCase() == "gandu") || (event.body.toLowerCase() == "bot tharki hai") || (event.body.toLowerCase() == "hijda")) {
     return api.sendMessage("chup kar tu hijda. :))))", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😡") || (event.body.toLowerCase() == "😤") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "😾")) {
     return api.sendMessage("️🥺 M toh Sirf Mazak Kr Rha Tha🥺. Gussa Mat Karo. Ek Chummi Lo aur Shant ho jaoo🤗😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "hm") || (event.body.toLowerCase() == "hmm")) {
     return api.sendMessage("️Hmm Hmm Na Karke Sidha Sidha bolo. Hey U Marry Me🙈", threadID);
   };

   if ((event.body.toLowerCase() == "😢") || (event.body.toLowerCase() == "😭") || (event.body.toLowerCase() == "🥺") || (event.body.toLowerCase() == "🥹")) {
     return api.sendMessage("️ 𝐊𝐲𝐚 𝐡𝐮𝐯𝐚 𝐫𝐨 𝐤𝐲𝐮 𝐫𝐡𝐞 𝐡𝐨 𝐜𝐡𝐨𝐜𝐨𝐥𝐚𝐭𝐞 𝐝𝐮𝐧𝐠𝙖 𝐥𝐢𝐤𝐡𝐨 𝐜𝐡𝐨𝐜𝐨𝐥𝐚𝐭𝐞 ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😮") || (event.body.toLowerCase() == "😱") || (event.body.toLowerCase() == "😦")) {
    return api.sendMessage("️Muh mat kholo itna chuha 🐀 pkd k dal dunga muh me៚♥😇", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤔🤔")) {
     return api.sendMessage("️Kya soch rahe ho etna nalayak🤨", threadID);
   };
if ((event.body.toLowerCase() == "himmat he") || (event.body.toLowerCase() == "bot pagal")) {
  ...
  if ((event.body.toLowerCase() == "happy rakhi") || (event.body.toLowerCase() == "happy rakshabandhan")) {
   ...
   if ((event.body.toLowerCase() == "😉") || (event.body.toLowerCase() == "😜")) {
     return api.sendMessage("Aakh mat mar teri setting pata lunga nahi to babu 🤣 <3", threadID);
   };

   if ((event.body.toLowerCase() == "soja tu") || (event.body.toLowerCase() == "Good night")) {
     return api.sendMessage("soja re kumbhkaran 😹", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "pagal") || (event.body.toLowerCase() == "pgl")) {
   ...
   if ((event.body.toLowerCase() == "jai shree ram") || (event.body.toLowerCase() == "Radhe Radhe")) {
     return api.sendMessage("~*-   ⛦꯭꯭⃕͜🦚➻⃝ 🇷꯭፝𝐀꯭፝𝐃꯭፝𝐇꯭፝𝐄͢🌸 ⃞᷼💖   -*~~*-   ⛦꯭꯭⃕͜🦚➻⃝ 🇷꯭፝𝐀꯭፝𝐃꯭፝𝐇꯭፝𝐄͢🌸 ⃞᷼💖   -*~😥", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "love u") || (event.body.toLowerCase() == "love u babu")) {
   ...
   if ((event.body.toLowerCase() == "good morning all") || (event.body.toLowerCase() == "gm")) {
     return api.sendMessage("UTH GAYE KUMBHKRN LOG CHALO MUH DHO KE AA JAO😜🤣 <3", threadID);
   };
